(function() {
  ...
  angular
    ...
    .component("sdCurrentThingTypesMap", {
      template: "<div id='map'></div>",
      controller: CurrentThingTypesMapController,
      bindings: {
        zoom: "@"
      }
    });
   ...
   // use maps component from subjects,just replace SubjectMap -> ThingTypesMap

  CurrentThingTypesMapController.$inject = ["$scope", "$q", "$element",
  ...
  function CurrentThingTypesMapController($scope, $q, $element, 
    ...
    vm.$onInit = function() {
      console.log("CurrentThingTypesMapController",$scope);
    }
  ...
  CurrentThingTypesMapController.prototype.updateOrigin = function() {
  ...
  CurrentThingTypesMapController.prototype.setActiveMarker = function(thing_id, image_id) {
    if (!this.map) { 
      return; 
  ...
  CurrentThingTypesMapController.prototype.originInfoWindow = function(location) {
  ...
  CurrentThingTypesMapController.prototype.thingInfoWindow = function(ti) {
  ...
  CurrentThingTypesMapController.prototype.imageInfoWindow = function(ti) {
